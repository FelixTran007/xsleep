        ...
        <div class="container">
            <div class="row align-items-center justify-content-between align-items-center">
                ...
                <div class="col-xl-6 col-md-4 d-none d-lg-block">
                    <form class="header-search-box" action="<?= route_to('search_vn') ?>" method="get">
                        <input class="form-control" type="text" name='q' id="search" placeholder="Tìm trong shop">
                        <button type="submit" class="btn-src">Tìm kiếm &nbsp;<i class="icon icofont-search-2"></i></button>
                    </form>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-9 col-lg-9">
                    <div class="header-navigation ms-0">
                        <ul class="main-nav">
                            <li class="main-nav-item has-submenu"><a <?= style_active_link("") ?> class="main-nav-link" href="<?= base_url() ?>">Trang chủ</a></li>
                            <li class="main-nav-item has-submenu"><a <?= style_active_link("san-pham") ?> class="main-nav-link" href="<?= base_url("san-pham") ?>">Sản phẩm</a>
                                <ul class="submenu-nav">
                                    <li class="submenu-nav-item"><a class="submenu-nav-link" href="<?= base_url("san-pham-goi") ?>">Gối</a></li>
                                    <li class="submenu-nav-item"><a class="submenu-nav-link" href="<?= base_url("san-pham-nem") ?>">Nệm</a></li>
                                </ul>
                            </li>
                            <li class="main-nav-item has-submenu"><a <?= style_active_link("bai-viet") ?> class="main-nav-link" href="<?= base_url("bai-viet") ?>">Bài viết</a>
                            </li>                            
                            <li class="main-nav-item"><a <?= style_active_link("lien-he") ?> class="main-nav-link" href="<?= base_url("lien-he") ?>">Liên hệ</a></li>
                        </ul>
                    </div>
                </div>
