        ...
        <aside class="aside-side-menu-wrapper off-canvas-area offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions">
            ...
            <div class="offcanvas-body">
                <div class="aside-search-form">
                    <form action="<?= route_to('search_vn') ?>" method="get">
                        <input id="search-input2" name="q" type="search" class="form-control" placeholder="Tìm trong cửa hàng">
                    ...
                    <nav id="offcanvasNav" class="offcanvas-menu">
                        <ul>
                            ...
                            <li><a href="#">Sản phẩm</a>
                                <ul>
                                    <li><a href="<?= base_url("san-pham") ?>">Tất cả</a></li>
                                    <li><a href="<?= base_url("san-pham-goi") ?>">Gối</a></li>
                                    <li><a href="<?= base_url("san-pham-nem") ?>">Nệm</a></li>
                                </ul>
                            </li>
                            <li><a href="<?= base_url("bai-viet") ?>">Bài viết</a></li>
