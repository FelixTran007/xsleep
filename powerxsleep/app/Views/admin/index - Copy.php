...
<head>
  ...
  <link rel="stylesheet" href="admin_assets/css/styles.min.css" />
</head>
...
<body>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h2>Chao mung <?= session('username') ?></h2>
                            <a href="<?= base_url('/logout') ?>">Dang xuat</a>
                          ...
                          <?php
                              if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                  ...
                                  echo "<h3>Nội dung đã nhập:</h3>";
                                  echo $content; // Lưu ý: nên lọc/escape nếu lưu trữ an toàn
                              }
                              ?>
                              ...
                              tinymce.init({
                                  ...
                                  Flmngr: {
                                      ...
                                      urlFileManager: 'https://huyuyprj.test/filemanager', // Relative to your base URL
                                      urlFiles: 'https://huyuyprj.test/uploads/', // Relative to your base URL, matching dirFiles
                                  },
                                  promotion: true,               
                              });
                              </script>
  ...
  <script src="admin_assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
  <script src="admin_assets/js/sidebarmenu.js"></script>
  <script src="admin_assets/js/app.min.js"></script>
  <script src="admin_assets/libs/apexcharts/dist/apexcharts.min.js"></script>
  <script src="admin_assets/libs/simplebar/dist/simplebar.js"></script>
